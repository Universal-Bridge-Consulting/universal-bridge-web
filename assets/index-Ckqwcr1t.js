        ...
        <section class="hero-section" style="padding: 3rem 0 2.5rem;">
          <div class="container">
            ...
            <div class="trademark-filter-bar">
              <button class="tm-filter-btn ${r===`all`?`active`:``}" data-tmfilter="all">All Trademarks (16)</button>
              <button class="tm-filter-btn ${r===`cargo`?`active`:``}" data-tmfilter="cargo">🚢 Supply Chain & Cargo (5)</button>
              <button class="tm-filter-btn ${r===`tech`?`active`:``}" data-tmfilter="tech">⚡ Tech, Math & Telematics (4)</button>
              <button class="tm-filter-btn ${r===`sovereign`?`active`:``}" data-tmfilter="sovereign">🏛️ Sovereign & Wall St (4)</button>
              <button class="tm-filter-btn ${r===`compliance`?`active`:``}" data-tmfilter="compliance">⚖️ Compliance & HUD (3)</button>
            </div>
          </div>
        </section>
