    ...
    <div class="theme-selector-bar">
      <div class="selector-top-row">
        ...
        <div class="category-tabs">
          <button class="cat-tab ${n===`mckinsey_fam`?`active`:``}" data-cat="mckinsey_fam">🏆 McKinsey & Federal (6)</button>
          <button class="cat-tab ${n===`topbrands`?`active`:``}" data-cat="topbrands">🏢 Top Companies (8)</button>
          ...
          <button class="cat-tab ${n===`all`?`active`:``}" data-cat="all">All (32)</button>
        </div>
      </div>
