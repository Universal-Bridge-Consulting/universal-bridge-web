    ...
    <div class="theme-selector-bar">
      <div class="selector-top-row">
        ...
        <div class="category-tabs">
          ...
          <button class="cat-tab ${n===`all`?`active`:``}" data-cat="all">All (26)</button>
        </div>
      </div>
