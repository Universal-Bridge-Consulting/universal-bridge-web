(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=document.querySelector(`#app`),t=`overview`,n=`logo-keystone`,r=[{id:`theme-mckinsey-sovereign`,cat:`mckinsey_fam`,name:`👑 M.1 McKinsey Pure Sovereign`,desc:`Deep McKinsey Midnight & Playfair Serif`},{id:`theme-mckinsey-swiss`,cat:`mckinsey_fam`,name:`📐 M.2 McKinsey x Swiss Grid`,desc:`Stark 2px Midnight Borders, Zero Radius & Space Grotesk`},{id:`theme-mckinsey-federal`,cat:`mckinsey_fam`,name:`🦅 M.3 McKinsey x Federal Audit`,desc:`Official Fed Navy, HUD Seal & Document Tables`},{id:`theme-mckinsey-dark`,cat:`mckinsey_fam`,name:`🌌 M.4 McKinsey Dark Boardroom`,desc:`Midnight Obsidian & Sapphire Platinum Lighting`},{id:`theme-mckinsey-walker`,cat:`mckinsey_fam`,name:`🍷 M.5 McKinsey x Walker SCM`,desc:`Alabaster Ivory, Deep Navy & SCM Crimson Accent`},{id:`theme-swiss-federal`,cat:`mckinsey_fam`,name:`⚖️ M.6 Swiss Federal Minimalist`,desc:`High-Speed Pure Compliance Grid & Red Stamp`},{id:`theme-stripe`,cat:`topbrands`,name:`🟣 Stripe (Fintech & Dev)`,desc:`Stripe Blurple Gradient & Precision Light Mode`},{id:`theme-palantir`,cat:`topbrands`,name:`🛡️ Palantir (Foundry Intel)`,desc:`Tactical Blueprint Blue & Titanium Command`},{id:`theme-linear`,cat:`topbrands`,name:`⚡ Linear (Craft Standard)`,desc:`Dark Obsidian & Glowing Luminous Micro-Borders`},{id:`theme-mckinsey`,cat:`topbrands`,name:`🏛️ McKinsey Standard`,desc:`McKinsey Midnight & Editorial Serif`},{id:`theme-wisetech`,cat:`topbrands`,name:`🌐 WiseTech (CargoWise Brand)`,desc:`WiseTech Royal Blue & Clean Freight Enterprise`},{id:`theme-apple-exec`,cat:`topbrands`,name:`🍎 Apple Pro (Cupertino Glass)`,desc:`Space Gray & Polished Frosted Titanium`},{id:`theme-bloomberg`,cat:`topbrands`,name:`📊 Bloomberg (Quant Matrix)`,desc:`Pure Black & High-Contrast Terminal Amber`},{id:`theme-vercel`,cat:`topbrands`,name:`▲ Vercel (Monochrome Speed)`,desc:`Pure Pitch Black & Sharp 1px Borders`},{id:`theme-v1-classic`,cat:`exec`,name:`1.1 Walker Classic Pure`,desc:`Corporate Navy & Crisp White`},{id:`theme-v2-crimson`,cat:`exec`,name:`1.2 Walker SCM Crimson`,desc:`Navy & Signature #8C2633 Burgundy`},{id:`theme-v3-cobalt`,cat:`exec`,name:`1.3 Cobalt Enterprise`,desc:`ThinkAutomation Cloud Pro`},{id:`theme-v4-steel`,cat:`exec`,name:`1.4 Slate & Steel Density`,desc:`Operations Logistics Command`},{id:`theme-v5-midnight`,cat:`exec`,name:`1.5 Midnight Boardroom`,desc:`Dark Executive Navy Hybrid`},{id:`theme-v6-platinum`,cat:`exec`,name:`1.6 Platinum & Sapphire`,desc:`Institutional Consulting Tier`},{id:`theme-brutalist`,cat:`radical`,name:`2.1 Swiss Brutalist`,desc:`Stark B&W, 3px Borders, Zero Radius`},{id:`theme-cyberpunk`,cat:`radical`,name:`2.2 Matrix Cyberpunk CRT`,desc:`Pure Black & Phosphor Green Glow`},{id:`theme-heavy-freight`,cat:`radical`,name:`2.3 Heavy Freight CAT`,desc:`Safety Yellow & Industrial Asphalt`},{id:`theme-tokyo-night`,cat:`radical`,name:`2.4 Tokyo Night Synth`,desc:`Deep Indigo, Neon Magenta & Violet`},{id:`theme-apple-monolith`,cat:`radical`,name:`2.5 High-Fashion Monolith`,desc:`Pitch Black & Hairline Monochrome`},{id:`theme-vaporwave`,cat:`radical`,name:`2.6 Retro Vaporwave`,desc:`Pastel Sunset Pink & Cyan Mint`},{id:`theme-nordic-warm`,cat:`heritage`,name:`3.1 Nordic Minimalist Paper`,desc:`Warm Ivory, Terracotta & Serif`},{id:`theme-sovereign-gold`,cat:`heritage`,name:`3.2 Sovereign Wall Street Gold`,desc:`Charcoal & Imperial Gilded Gold`},{id:`theme-emerald-wealth`,cat:`heritage`,name:`3.3 Private Equity Emerald`,desc:`British Racing Green & Champagne`},{id:`theme-federal-gov`,cat:`heritage`,name:`3.4 Federal HUD Defense`,desc:`Official Fed Navy & Red Audit Stamp`},{id:`theme-neumorphic`,cat:`heritage`,name:`3.5 Soft Clay Neumorphic`,desc:`Tactile 3D Extruded Shadows`},{id:`theme-retro-mac`,cat:`heritage`,name:`3.6 Retro Mac 1984 GUI`,desc:`System 7 Platinum Gray & Bevels`}],i=`mckinsey_fam`,a=`theme-mckinsey-sovereign`,o=`cargowise`,s=[{id:`logo-keystone`,name:`The Sovereign Keystone Bridge`,badge:`Institutional Architecture`,desc:`Classical Roman triumphal arch anchored by two enterprise monoliths with a central interlocking keystone. Symbolizes unshakeable structural permanence, compliance standards, and corporate trust.`,specs:{Geometry:`Keystone Arch & Dual Pylons`,Rationale:`16-Year Institutional Stability`,FaviconScale:`Optimal at 16px/32px`},svg:`
    ...
    `},{id:`logo-data-span`,name:`The Binary Data Span`,badge:`High-Throughput Routing`,desc:`Twin vertical mainframe towers bridged by 3 high-velocity data pipelines (Air, Ocean, and Compliance Telematics). Represents sub-second WiseTech CargoWise & ThinkAutomation throughput.`,specs:{Geometry:`Twin Pylons + Triple Vector Span`,Rationale:`Multi-Leg Freight Middleware`,FaviconScale:`High-contrast clean`},svg:`
      <svg viewBox="0 0 100 100" class="trademark-svg" fill="none" stroke="currentColor">
    ...
    `},{id:`logo-ub-monogram`,name:`The Linked UB Monogram`,badge:`Executive Sovereign Ligature`,desc:`An interlocking monogram where the curves of the capital "U" descend and form the suspension cables of a grand bridge, fusing seamlessly into the structural counter of the capital "B".`,specs:{Geometry:`Interlocking UB Monogram`,Rationale:`Executive Consulting & Wall St Brand`,FaviconScale:`Instant Recognition`},svg:`
      <svg viewBox="0 0 100 100" class="trademark-svg" fill="none" stroke="currentColor">
    ...
    `},{id:`logo-hex-conduit`,name:`The Hexagonal Node Conduit`,badge:`Algorithmic Systems Engine`,desc:`A precision isometric hexagon containing an internal diagonal bridge corridor. Represents complex data structures, low-latency compiler algorithms, and database internals.`,specs:{Geometry:`Isometric Hexagon + Bridge Conduit`,Rationale:`Systems Engineering & Algorithms`,FaviconScale:`Pixel-sharp on retina`},svg:`
      <svg viewBox="0 0 100 100" class="trademark-svg" fill="none" stroke="currentColor">
    ...
    `},{id:`logo-swiss-cantilever`,name:`The Swiss Brutalist Cantilever`,badge:`Architectural Pure Geometry`,desc:`Stark 45-degree geometric cantilever bridge formed from interlocking architectural planes. Zero fluff, pure functional mass, and absolute structural confidence.`,specs:{Geometry:`45-Degree Solid Bevel & Cantilever`,Rationale:`Bauhaus & Swiss Typographic Rigor`,FaviconScale:`Maximum punch at small size`},svg:`
      <svg viewBox="0 0 100 100" class="trademark-svg" fill="none" stroke="currentColor">
    ...
    `},{id:`logo-mobius-infinity`,name:`The Möbius Infinity Span`,badge:`Continuous Supply Chain Flow`,desc:`An unbroken, perpetual Möbius ribbon arching through 3D space. Symbolizes nonstop global ocean/air cargo movement, resilient feedback loops, and 16 years of perpetual enterprise standing.`,specs:{Geometry:`Continuous Topological Bridge Ribbon`,Rationale:`Perpetual Logistics Continuity`,FaviconScale:`Smooth vector flow`},svg:`
      <svg viewBox="0 0 100 100" class="trademark-svg" fill="none" stroke="currentColor">
    ...
    `},{id:`logo-federal-shield`,name:`The Federal Keystone Shield`,badge:`Regulatory Compliance & HUD`,desc:`An institutional security shield containing an arching bridge keystone and three five-pointed audit stars. Built specifically for Certified Occupancy Specialist authority and defense contractor compliance.`,specs:{Geometry:`Heraldic Defense Shield + Bridge Arch`,Rationale:`HUD 50059, TRACS & Audit Defense`,FaviconScale:`Prestigious crest silhouette`},svg:`
      <svg viewBox="0 0 100 100" class="trademark-svg" fill="none" stroke="currentColor">
    ...
    `},{id:`logo-compass-navigator`,name:`The Global Navigator Arch`,badge:`Intercontinental Logistics`,desc:`A nautical quadrant sextant arc intersecting with precision digital suspension cables. Represents trans-oceanic navigation, international shipping lanes, and precision port-to-door telemetry.`,specs:{Geometry:`Nautical Sextant + Suspension Cable Array`,Rationale:`Global Maritime & Air Freight`,FaviconScale:`Sharp navigational emblem`},svg:`
      <svg viewBox="0 0 100 100" class="trademark-svg" fill="none" stroke="currentColor">
    ...
    `}],c={cargowise:{title:`WiseTech CargoWise One Integration`,desc:`Sub-second multi-leg air & ocean data enrichment pipeline powering Fortune 500 supply chain visibility.`,specs:[{label:`Throughput SLA`,value:`< 250ms per transaction`},{label:`Read Replica Joins`,value:`GlobalOceanWeekly View Injections`},{label:`Data Integrity`,value:`100% Strict Audit Mode`},{label:`Middleware Layer`,value:`ThinkAutomation C#`}],code:`// [WiseTech CargoWise One Data Adapter]
...
void OnCanFrameReceived(uint32_t pgn, const uint8_t* data) {
...
}`}};function l(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}function u(e){a=e,document.body.className=e,d()}function d(){let f=c[o],p=s.find(e=>e.id===n)||s[0],m=f.specs.map(e=>`
    <tr>
      <td class="label">${e.label}</td>
      <td class="val">${e.value}</td>
    </tr>
  `).join(``),h=(i===`all`?r:r.filter(e=>e.cat===i)).map(e=>`
    <button class="theme-btn ${a===e.id?`active`:``}" data-theme="${e.id}" title="${e.desc}">
      ${e.name}
    </button>
  `).join(``),g=s.map(e=>`
      ...
      <div class="trademark-body">
        <div>
          ...
          <table class="trademark-specs-table">
            <tr><td class="k">Geometry</td><td class="v">${e.specs.Geometry}</td></tr>
            <tr><td class="k">Domain</td><td class="v">${e.specs.Rationale}</td></tr>
            <tr><td class="k">Scaling</td><td class="v">${e.specs.FaviconScale}</td></tr>
          </table>
        </div>
    ...
    <div class="theme-selector-bar">
      <div class="selector-top-row">
        ...
        <div class="category-tabs">
          <button class="cat-tab ${i===`mckinsey_fam`?`active`:``}" data-cat="mckinsey_fam">🏆 McKinsey & Federal (6)</button>
          <button class="cat-tab ${i===`topbrands`?`active`:``}" data-cat="topbrands">🏢 Top Companies (8)</button>
          <button class="cat-tab ${i===`exec`?`active`:``}" data-cat="exec">Executive (6)</button>
          <button class="cat-tab ${i===`radical`?`active`:``}" data-cat="radical">Radical / Tech (6)</button>
          <button class="cat-tab ${i===`heritage`?`active`:``}" data-cat="heritage">Heritage / Gov (6)</button>
          <button class="cat-tab ${i===`all`?`active`:``}" data-cat="all">All (32)</button>
        </div>
      </div>
          ...
          <div class="cockpit-wrapper">
            <div class="cockpit-bar">
              <div class="cockpit-tabs">
                <button class="tab-btn ${o===`cargowise`?`active`:``}" data-tab="cargowise">⚡ CargoWise One</button>
                <button class="tab-btn ${o===`yardi`?`active`:``}" data-tab="yardi">⚖️ HUD & Yardi Schema</button>
                <button class="tab-btn ${o===`fleet`?`active`:``}" data-tab="fleet">🛰️ Fleet Telematics</button>
                <button class="tab-btn ${o===`dossier`?`active`:``}" data-tab="dossier">🏛️ Corporate Dossier</button>
              </div>
            ...
            <div class="split-grid">
              <div class="spec-pane">
                ...
                <div>
                  <a href="mailto:ceo@universalbridgeconsulting.com?subject=Consultation: ${encodeURIComponent(f.title)}" class="btn-primary" style="padding:0.6rem 1.25rem;font-size:0.85rem;">
  ...
  `,document.querySelectorAll(`.page-switch-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let n=e.getAttribute(`data-view`);n&&(t=n,d(),window.scrollTo({top:0,behavior:`smooth`}))})}),document.querySelectorAll(`.select-mark-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-logo`);t&&(n=t,d())})}),document.querySelectorAll(`.cat-tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-cat`);t&&(i=t,d())})}),document.querySelectorAll(`.theme-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-theme`);t&&u(t)})}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-tab`);t&&c[t]&&(o=t,d())})})}document.body.className=a,d();